...
def setTitle(_str):
    ...
    if system == 'nt':
        #if its windows
        ctypes.windll.kernel32.SetConsoleTitleW(f"{_str} | sloppy")
    elif system == 'posix':
        #if its linux
        sys.stdout.write(f"\x1b]0;{_str} | sloppy\x07")
    else:
...
def proxy_scrape(): 
    ...
    startTime = time.time()
    #create temp dir
    temp = getTempDir()+"\\zxlpvx"
    print(f"{Fore.YELLOW}Loading please be patient.{Fore.RESET}")
    ...
    print(f"{Fore.GREEN}Scraped without an error!{Fore.MAGENTA}{len(proxies): >5}{Fore.GREEN} Done => {Fore.RED}{temp}{Fore.RESET} | {execution_time}m/s")
    setTitle(f"zxlpvx {THIS_VERSION}")
...
{Fore.RESET}[{Fore.GREEN}⸸{Fore.RESET}]{Fore.LIGHTBLACK_EX} Nuke Account                                |{Fore.RESET}[{Fore.GREEN}⸸{Fore.RESET}]{Fore.LIGHTBLACK_EX} Block Friends

{Fore.RESET}[{Fore.GREEN}⸸{Fore.RESET}]{Fore.LIGHTBLACK_EX} Unfriend all friends                        |{Fore.RESET}[{Fore.GREEN}⸸{Fore.RESET}]{Fore.LIGHTBLACK_EX} Profile Changer

{Fore.RESET}[{Fore.GREEN}⸸{Fore.RESET}]{Fore.LIGHTBLACK_EX} Delete and leave all servers                |{Fore.RESET}[{Fore.GREEN}⸸{Fore.RESET}]{Fore.LIGHTBLACK_EX} [Coming Soon]

{Fore.RESET}[{Fore.GREEN}⸸{Fore.RESET}]{Fore.LIGHTBLACK_EX} Spam Create New servers                     |{Fore.RESET}[{Fore.GREEN}⸸{Fore.RESET}]{Fore.LIGHTBLACK_EX} Create Token Grabber 

{Fore.RESET}[{Fore.GREEN}⸸{Fore.RESET}]{Fore.LIGHTBLACK_EX} Dm Deleter                                  |{Fore.RESET}[{Fore.GREEN}⸸{Fore.RESET}]{Fore.LIGHTBLACK_EX} QR Code grabber

{Fore.RESET}[{Fore.GREEN}⸸{Fore.RESET}]{Fore.LIGHTBLACK_EX} Mass Dm                                     |{Fore.RESET}[{Fore.GREEN}⸸{Fore.RESET}]{Fore.LIGHTBLACK_EX} Mass Report

{Fore.RESET}[{Fore.GREEN}⸸{Fore.RESET}]{Fore.LIGHTBLACK_EX} Enable Seizure Mode                         |{Fore.RESET}[{Fore.GREEN}⸸{Fore.RESET}]{Fore.LIGHTBLACK_EX} GroupChat Spammer

{Fore.RESET}[{Fore.GREEN}⸸{Fore.RESET}]{Fore.LIGHTBLACK_EX} Get information from a targetted account    |{Fore.RESET}[{Fore.GREEN}⸸{Fore.RESET}]{Fore.LIGHTBLACK_EX} Webhook Destroyer

{Fore.RESET}[{Fore.GREEN}⸸{Fore.RESET}]{Fore.LIGHTBLACK_EX} Log into an account                         |{Fore.RESET}[{Fore.GREEN}⸸{Fore.RESET}]{Fore.RED} Settings
{Fore.WHITE}────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────''')
...
⠀                    \____$$  |\$$\ $$  |$$ |$$  __$$\\$$\  $$  |\$$\ $$  |
 ...
 ⠀                    $$  _/    $$  $$<  $$ |$$ |  $$ | \$$$  /   $$  $$<  
⠀                    $$$$$$$$\ $$  /\$$\ $$ |$$$$$$$  |  \$  /   $$  /\$$\ 
⠀                    \________|\__/  \__|\__|$$  ____/    \_/    \__/  \__|
⸸ zxlpvx#8788                                $$ |                          
⸸ https://solo.to/sin666                     $$ |                          
⸸ https://ln.ki/zxlpvx                       \__|                           ''')+type2('''  

                                 Hate the sin, Love the sinner.

⸸ Nuke Account                                ⸸ Block Friends

⸸ Unfriend all friends                        ⸸ Profile Changer

⸸ Delete and leave all servers                ⸸ [Coming Soon]

⸸ Spam Create New servers                     ⸸ Create Token Grabber 

⸸ Dm Deleter                                  ⸸ QR Code grabber

⸸ Mass Dm                                     ⸸ Mass Report

⸸ Enable Seizure Mode                         ⸸ GroupChat Spammer

⸸ Get information from a targetted account    ⸸ Webhook Destroyer

⸸ Log into an account                         ⸸ Settings
